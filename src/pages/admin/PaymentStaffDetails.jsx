...
export default function PaymentStaffDetails() {
    ...
    return (
        <div className="bg-gray-100 h-[92vh] p-2 md:p-6 overflow-y-auto">
            <h1 className="text-lg font-semibold text-gray-800 mb-6">STAFF PAYMENT DETAILS</h1>
            ...
            <div className="bg-white shadow p-4 md:p-6 mb-8">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-2 sm:gap-4 justify-end">
                    ...
                    <button onClick={() => navigate("/admin_dashboard/payment_staff_history")} className="bg-purple-600 text-white px-4 py-2 hover:bg-purple-700 transition text-sm w-full sm:w-auto cursor-pointer">PAYMENT HISTORY</button>
                    <button onClick={() => navigate("/admin_dashboard/payment_staff_receipt")} className="bg-yellow-600 text-white px-4 py-2 hover:bg-yellow-700 transition text-sm w-full sm:w-auto cursor-pointer">RECEIPT</button>
                    <button onClick={() => navigate("/admin_dashboard/payment_staff")} className="bg-green-600 text-white px-4 py-2 hover:bg-green-700 transition text-sm w-full sm:w-auto cursor-pointer">PAY SALERY</button>
